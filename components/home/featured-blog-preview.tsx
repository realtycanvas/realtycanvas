  ...
  return (
    <section className="bg-white py-14 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded border border-gray-200 bg-linear-to-br from-white to-gray-50 p-6 sm:p-8 lg:p-10 shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-8 lg:gap-14 items-start">
            <div className="space-y-5 sm:space-y-6">
              ...
              <ViewAllLink href="/blog/senior-living-india" label="Read More" className="mt" />
            </div>

            <div className="flex justify-center lg:justify-end">
              <div className="w-full max-w-72 rounded overflow-hidden border border-gray-200 shadow-md bg-black">
                <video
