        ...
        <div className="rounded-2xl border border-gray-200 bg-linear-to-br from-white to-gray-50 p-6 sm:p-8 lg:p-10 shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-8 lg:gap-14 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-full max-w-85 rounded-2xl overflow-hidden border border-gray-200 shadow-md bg-black">
                <video src="https://cdn.realtycanvas.in/projects/videos/blog.mp4" controls playsInline className="w-full aspect-9/16 object-cover" />
              </div>
            </div>
          </div>
        </div>
